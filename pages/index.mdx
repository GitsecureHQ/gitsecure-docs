...
Teams of different sizes make multiple commits to their remote repo every day, pushing constant updates and changes to their product. The rate at which developers leak their critical software secrets including API keys, and in some cases, even passwords is steadily increasing.
