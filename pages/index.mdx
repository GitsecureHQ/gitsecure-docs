...
Teams of different sizes make multiple commits to their remote repo, pushing constant updates and changes to their product. The rate at which developers leak their critical software secrets including API keys, and most times even passwords is steadily increasing.
